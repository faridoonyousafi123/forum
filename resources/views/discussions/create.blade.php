                  ...
                  <div class="card-body">
                     <div class="col-lg-12">
                        <div class="card-body card-block">
                           <form action="{{route('discussion.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                           {{csrf_field()}}

                            <div class="row form-group">
                                 <div class="col col-md-3"><label for="title" class=" form-control-label">Title</label></div>
                                 <div class="col-12 col-md-9"><input name="title" id="title" class="form-control"></input></div>
                              </div>
